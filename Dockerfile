...
RUN apt update
RUN apt install --yes temurin-11-jdk temurin-8-jdk
...
COPY --from=builder /opt/dremio/distribution/server/target/dremio-oss-24.3.2-*/dremio-oss-24.3.2-* /opt/dremio/
COPY ./dremio-ce-services-cachemanager-24.3.2-202401241821100032-d2d8a497.jar /opt/dremio/jars/
EXPOSE 9047/tcp
EXPOSE 31010/tcp
EXPOSE 45678/tcp
